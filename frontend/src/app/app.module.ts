...
import { NgbdModal7Content } from './components/hod-application/hod-application.component';
import { NgbdModal8Content } from './components/hod-application/hod-application.component';
